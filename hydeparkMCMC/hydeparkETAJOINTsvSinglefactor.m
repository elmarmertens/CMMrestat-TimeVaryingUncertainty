%% JOINT ETA-SV model across multiple variables (and with singlefactor SV)
% uses MDS assumption
...
parfor thisT = Tstart : T - 1 % @parfor
    TID = parid;
    [mcmc_feSV, mcmc_fe, mcmc_etaSV] = mcmcsamplerSVsinglefactorjoint(ETA, ETAnanny, ...
        thisT, horizons, MCMCdraws, MCMCburnin, Nfedraws, doZeroSlopes, doDiffuseSlopes, rndStreams{TID}, false);  %#ok<*PFBNS>
